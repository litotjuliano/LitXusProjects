...
| — | [Phase 2 User Guide](phase-2-sales/User_Guide.md) | Click-by-click walkthrough for billing a customer, recording/verifying a payment, and issuing a credit note through the actual UI, with screenshots |
